          ...
          <el-card class="card-container">
            ...
            <div class="material_table" style="width: 100%">
              ...
              <el-table v-loading="loading1" :data="tableList" style="width: 100%">
                ...
                <el-table-column label="品种ID" align="center" prop="kindId" width="80px" >
                ...
                <el-table-column label="材料编号" align="center" prop="materialId" width="180px">
                ...
                <el-table-column label="父本" align="center" prop="father" width="150px">
                  <template #default="scope">{{scope.row.father?scope.row.father:'-'}}</template>
                </el-table-column>
                <el-table-column label="母本" align="center" prop="mother" width="150px">
                  <template #default="scope">{{scope.row.mother?scope.row.mother:'-'}}</template>
                </el-table-column>

                <el-table-column label="操作" align="center" width="150px">
                  <template  #default="{ row }" >
                    <!--<el-button @click="handleExitDetails()" size="mini" type="text" style="font-size: 10px">基因型</el-button>-->
...
//跳转操作
/*function handleExitDetails(param){
  router.push({path:'/genotype/geno',query:{param}})
}*/
...
/*function handleExitPca(param){
  const fileId = reactive(param.fileId)
  console.log(fileId)
  router.push({path:'/genotype/pca',query:{fileId}})
}*/
...
function resetQuery() {
  ...
  //pageSize.value = 10;
  queryParams.value.kindId = "";
  queryParams.value.kindName = "";
  queryParams.value.materialId = "";
  queryParams.value.fieldId = "";
  queryParams.value.controlType = "";
  queryParams.value.father = "";
  queryParams.value.mother = "";
