...
<script setup>
import {ref, getCurrentInstance, nextTick, onMounted, onBeforeUnmount} from "vue";
...
const message = {
  ...
  info:computed(()=>i18n.t('decision.upload.info')).value,
...
const typeList = reactive([
  ...
  {
    title: message.info,
    url:"/infomanage/admin/character/type"
  },
  {
