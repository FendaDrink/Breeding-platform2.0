          ...
          <el-card class="card-container">
            <template #header>
              <div class="card-header">
                <span>{{ $t('phenotype.visualization.phenoImage.phenoImage_header') }}</span>
              </div>
            </template>
            <!-- 文件统计 -->
...
// eChart相关
const visualization = {
  barChart_title:computed(()=>i18n.t('phenotype.visualization.phenoImage.barChart_title')).value,
  lineChart_title:computed(()=>i18n.t('phenotype.visualization.phenoImage.lineChart_title')).value,
