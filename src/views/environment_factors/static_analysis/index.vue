          ...
          <el-card class="card-container">
            <template #header>
              <div class="card-header">
                <span>{{ $t('environment.visualization.header') }}</span>
              </div>
            </template>
            <!-- 文件统计 -->
            <div class="big-wrapper" style="margin-top: 10px;">
              <div class="block">
                <!-- 日期选择 -->
                <span style="font-weight: bold;font-size: 18px;color:#606266">{{ $t('environment.visualization.select_date') }}：</span>
                <el-date-picker v-model="value2"
                                type="daterange"
                                unlink-panels :range-separator="$t('environment.visualization.to')"
                                :start-placeholder="$t('environment.visualization.dateRange.start')"
                                :end-placeholder="$t('environment.visualization.dateRange.end')"
                                :shortcuts="shortcuts"
                                :size="size"
