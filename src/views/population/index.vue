    ...
    <el-table v-loading="loading" :data="populationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button  link size="large" icon="Edit" type="text" @click="handleUpdate(scope.row)"  class="table_button">修改</el-button >
          <el-button  link size="large" type="text" icon="Delete" @click="handleDelete(scope.row)" class="table_button">删除</el-button >
        </template>
      </el-table-column>
    </el-table>
