    ...
    <el-card>
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="98px">
        ...
        <el-form-item :label="$t('basic.label.traitName')">
          <el-input v-model="add.name" :placeholder="$t('basic.placeholder.trait')" clearable @keyup.enter.native="handleQuery" />
        </el-form-item>
        <el-form-item>
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button type="warning" plain @click="isModify"
                     :loading="isModifing"
                     icon="edit"
                     v-hasPermi="['system:trait:export']">{{$t('basic.button.confirmUpdate')}}</el-button>
        </el-col>
