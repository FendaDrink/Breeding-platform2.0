  ...
  <div class="app-container" style="width: 100%;min-height: calc(100vh - 84px);background-color: #eeeeee;">
    <el-card>
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
        <el-form-item :label="$t('basic.label.trait')" prop="traitTypeId" label-width="80">
    ...
    <el-dialog :title="title" v-model="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item :label="$t('basic.table.trait')" prop="traitTypeName">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm((localStorage.getItem('lang') === 'zh-CN' || !localStorage.getItem('lang'))  ? '是否确认删除名称为'+" '"+traitTypeNames+"' "+'的性状类别?' : 'Are you sure you want to delete the item named'+" '"+traitTypeNames+"' "+"?").then(function () {        return delType(asTraitTypeIds);
      }).then(() => {
        this.getList();
